...
export { type Vector3D, vec3d, length, normalize, add, subtract, scale, dot, cross, negate, X_AXIS, Y_AXIS, Z_AXIS } from './vector3d';
...
export { type Transform3D, identity, translation, rotationX, rotationY, rotationZ, scaling, compose, inverse, transformPoint, transformVector } from './transform3d';
